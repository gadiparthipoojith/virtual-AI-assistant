try:
    ...
    print(f"ERROR OCCURRED WHILE IMPORTING THE MODULES: {str(e)}")
    exit(0)
...
# load trained model
model = load_model('Virtual-Voice-Assistant-main\Data\chat_model')

# load tokenizer object
with open('Virtual-Voice-Assistant-main\Data\tokenizer.pickle', 'rb') as handle:
    tokenizer = load(handle)

# load label encoder object
with open('Virtual-Voice-Assistant-main\Data\label_encoder.pickle', 'rb') as enc:
